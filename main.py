...
model = torch.hub.load('ultralytics/yolov5', 'custom', path='yolov5ID_640_100epoch.pt')
model.load_state_dict(torch.load('yolov5ID_640_100epoch.pt')['model'].state_dict(), strict=False)

# load foootball detection model
ballmodel = torch.hub.load('ultralytics/yolov5', 'custom', path='balldetection640_100epoch.pt')
...
loaded_model.get_layer("conv2d_15").output)
